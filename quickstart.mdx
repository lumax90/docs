...
<Steps>
  ...
  <Step title="Annotate your first task">
    ...
    <Frame caption="Two Vehicle boxes and one Pedestrian box drawn with class hotkeys. The left panel tracks every object instance.">
      <img src="/images/docs/quickstart/annotate-editor.png" alt="PixlHub annotation editor with labeled bounding boxes on a street scene and the object instances panel" />
    </Frame>
  </Step>
